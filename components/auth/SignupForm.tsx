    ...
    >
      ...
      <div className="grid gap-2">
        <label htmlFor="su-company" className="text-sm font-medium text-stone-800">
          {t("companyName")}{" "}
          <span className="text-xs font-normal text-stone-500">({tCommon("optional")})</span>
        </label>
        <input
          id="su-company"
          name="companyName"
      ...
      <div className="grid gap-2">
        <label htmlFor="su-confirm-password" className="text-sm font-medium text-stone-800">
          {t("confirmPassword")}
        </label>
        <input
      ...
      <Submit label={t("submitSignup")} disabled={!passwordMeetsRequirements || !passwordsMatch} />
