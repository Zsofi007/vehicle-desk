...
export function LanguageSwitcher({ ariaLabel, persistPreference = true }: Props) {
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-slate-200 bg-white shadow-sm hover:bg-slate-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-600"
      >
        <ActiveFlag
