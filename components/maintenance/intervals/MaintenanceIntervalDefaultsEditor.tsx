                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      setRows((prev) =>
                        prev.map((p, i) =>
                          i === idx
                            ? { ...p, interval_km: Number.isFinite(next) ? next : null }
                            : p,
                        ),
                      );
                    }}
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      setRows((prev) =>
                        prev.map((p, i) =>
                          i === idx
                            ? { ...p, interval_days: Number.isFinite(next) ? next : null }
                            : p,
                        ),
                      );
                    }}
                      ...
                      setRows((prev) =>
                        prev.map((p, i) =>
                          i === idx
                            ? {
                                ...p,
                                due_soon_km: Number.isFinite(next) ? next : p.due_soon_km,
                              }
                            : p,
                        ),
                      );
                      ...
                      setRows((prev) =>
                        prev.map((p, i) =>
                          i === idx
                            ? {
                                ...p,
                                due_soon_days: Number.isFinite(next) ? next : p.due_soon_days,
                              }
                            : p,
                        ),
                      );
